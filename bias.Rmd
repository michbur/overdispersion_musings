---
title: "Bias introduced by over/underdispersion"
...
If $p = 1$, than we have normal Poisson distribution.
...
When $p < 1$, the distribution is overdispersed.
...
ggplot(bias_res, aes(x = as.factor(lambda), fill = p, y = bias)) +
  geom_bar(stat = "identity", position = "dodge") +
  scale_x_discrete(expression(lambda)) +
